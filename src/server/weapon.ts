import { world, EntityDamageCause, EntityHurtAfterEvent, 
    system, Player, 
    ItemLockMode, ItemStack, EntityHealthComponent } from "@minecraft/server";
...
world.afterEvents.entityHurt.subscribe((e)=>{
    ...
    if(damagingEntity?.typeId !== MinecraftEntityTypes.Player||e.damageSource.cause!==EntityDamageCause.entityAttack) return;
